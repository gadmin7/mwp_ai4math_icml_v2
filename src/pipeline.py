...
#
# Purpose: distinguish two very different failure modes. If fine-tuning merely
# overwrote the model's DEFAULT answering format, prompting for that format should
# recover much of the lost accuracy. If the underlying reasoning was damaged, it will
# not. One is fixable with a prompt; the other needs the training target changed.
PROMPT_TEMPLATE_COT = (
    "<|begin_of_text|><|start_header_id|>system<|end_header_id|>\n"
    "You are an expert math assistant<|eot_id|><|start_header_id|>user<|end_header_id|>\n"
